...
public class DeveloperController {
    ...
    @FXML public void dev1ShowInfo() {
        Image image = new Image(getClass().getResourceAsStream("/images/dev1.jpg"));
    ...
    @FXML public void dev2ShowInfo() {
        Image image = new Image(getClass().getResourceAsStream("/images/dev2.jpg"));
        profileImageView.setImage(image);
    ...
    @FXML public void dev3ShowInfo() {
        Image image = new Image(getClass().getResourceAsStream("/images/dev3.jpg"));
        profileImageView.setImage(image);
    ...
    @FXML public void dev4ShowInfo() {
        Image image = new Image(getClass().getResourceAsStream("/images/dev4.jpg"));
        profileImageView.setImage(image);
    ...
    @FXML public void clearDisplay() {
        Image image = new Image(getClass().getResourceAsStream("/images/proflie.png"));
        profileImageView.setImage(image);
        nameLabel.setText("");
        idLabel.setText("");
        githubLabel.setText("");
